                ...
                <div className='conteiner'>
                    ...
                    <div className='ourcompany-about'>
                        <div className='ourcompany-block'>
                            <img src={require('../img/our-block-box.png')} className='ourcompany-block__img' alt='наша компанія'/>
                        ...
                        <div className='ourcompany-block'>
                            <img src={require('../img/our-block-gear.png')} className='ourcompany-block__img' alt='наша компанія'/>
                        ...
                        <div className='ourcompany-block'>
                            <img src={require('../img/our-block-search.png')} className='ourcompany-block__img' alt='наша компанія'/>
